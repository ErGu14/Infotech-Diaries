...
{// burası invititaions ile alakalı getir yarat düzenle gibi işlerirmizi yapıyoruz  dışarıya görünecek kısımları burda toparlııyoruz 
    ...
    public class InvitationService
    {
        ...
        {
            var invitations = _invitationRepository.GeyById(id);  // new demek gibi repositorydeki metodu çağırııyoruz
        ...
        {
            var invitation = _invitationRepository.GeyById(model.Id);
        ...
        {
            var invitation = _invitationRepository.GeyById(id);
