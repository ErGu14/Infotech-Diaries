...
namespace ECommerce.Businnes.Abstract
{
    public interface IProductService
    {
        ...
        Task<ResponseDTO<IEnumerable<ProductDTO>>> GetByCategoryAsync(); // aktif olan şu kategorideki *ürünleri* getir

        Task<ResponseDTO<ProductDTO>> AddAsync(ProductCreateDTO productCreateDTO);
        Task<ResponseDTO<NoContent>> UpdateAsync(ProductDTO productDTO);
