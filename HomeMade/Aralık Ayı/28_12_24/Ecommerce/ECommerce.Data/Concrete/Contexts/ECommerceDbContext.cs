...
namespace ECommerce.Data.Concrete.Contexts
{
    public class ECommerceDbContext : IdentityDbContext<ApplicationUser, ApplicationRole, string>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<OrderItem>().Property(p => p.UnitPrice).HasColumnType("decimal(18,2)");
            ...
            List<Product> products = new List<Product>
            {
                ...
                new Product { Id = 1, Name = "Akıllı Telefon", Price = 2999.99m, Properties = "Son model akıllı telefon" },
                new Product { Id = 2, Name = "Laptop", Price = 4999.99m, Properties = "Yüksek performanslı laptop" },
                new Product { Id = 3, Name = "Kamera", Price = 1999.99m, Properties = "Yüksek çözünürlüklü kamera" },
                new Product { Id = 4, Name = "Tablet", Price = 1999.99m, Properties = "Taşınabilir tablet" },
                new Product { Id = 5, Name = "Bluetooth Hoparlör", Price = 399.99m, Properties = "Kablosuz hoparlör" },
                new Product { Id = 6, Name = "Akıllı Saat", Price = 799.99m, Properties = "Akıllı saat" },
                new Product { Id = 7, Name = "Kulaklık", Price = 299.99m, Properties = "Kablosuz kulaklık" },
                new Product { Id = 8, Name = "Dizüstü Bilgisayar", Price = 3499.99m, Properties = "Hafif dizüstü bilgisayar" },
                new Product { Id = 9, Name = "Oyun Konsolu", Price = 2499.99m, Properties = "Yeni nesil oyun konsolu" },
                new Product { Id = 10, Name = "Masaüstü Bilgisayar", Price = 3999.99m, Properties = "Güçlü masaüstü bilgisayar" },
                new Product { Id = 11, Name = "Yazıcı", Price = 499.99m, Properties = "Renkli yazıcı" },
                new Product { Id = 12, Name = "Tarayıcı", Price = 299.99m, Properties = "Doküman tarayıcı" },
                new Product { Id = 13, Name = "Projeor", Price = 1999.99m, Properties = "Ev sinema sistemi için projektör" },
                new Product { Id = 14, Name = "Kamera Lens", Price = 799.99m, Properties = "Yüksek kaliteli lens" },
                new Product { Id = 15, Name = "Aksiyon Kamerası", Price = 1499.99m, Properties = "Aksiyon çekimleri için kamera" },
                new Product { Id = 16, Name = "Küçük Ev Aletleri", Price = 299.99m, Properties = "Küçük ev aletleri" },
                new Product { Id = 17, Name = "Mutfak Robotu", Price = 899.99m, Properties = "Mutfak robotu" },
                new Product { Id = 18, Name = "Blender", Price = 199.99m, Properties = "Blender" },
                new Product { Id = 19, Name = "Mikser", Price = 149.99m, Properties = "Mikser" },
                new Product { Id = 20, Name = "Fırın", Price = 1999.99m, Properties = "Dijital fırın" },

                // Kozmetik ve Hediyelik Eşya kategorisine dahil ürünler
                new Product { Id = 21, Name = "Ruj", Price = 49.99m, Properties = "Kırmızı ruj" },
                new Product { Id = 22, Name = "Parfüm", Price = 199.99m, Properties = "Kadın parfümü" },
                new Product { Id = 23, Name = "Krem", Price = 79.99m, Properties = "Nemlendirici krem" },
                new Product { Id = 24, Name = "Şampuan", Price = 39.99m, Properties = "Saç şampuanı" },
                new Product { Id = 25, Name = "Dudak Balmı", Price = 19.99m, Properties = "Nemlendirici dudak balmı" },
                new Product { Id = 26, Name = "Makyaj Seti", Price = 299.99m, Properties = "Makyaj seti" },
                new Product { Id = 27, Name = "Göz Farı", Price = 59.99m, Properties = "Göz farı" },
                new Product { Id = 28, Name = "Oje", Price = 29.99m, Properties = "Renkli oje" },
                new Product { Id = 29, Name = "Cilt Bakım Seti", Price = 199.99m, Properties = "Cilt bakım seti" },
                new Product { Id = 30, Name = "Vücut Losyonu", Price = 89.99m, Properties = "Vücut losyonu" },
                new Product { Id = 31, Name = "Saç Spreyi", Price = 39.99m, Properties = "Saç spreyi" },
                new Product { Id = 32, Name = "Makyaj Ayna", Price = 49.99m, Properties = "Makyaj aynası" },
                new Product { Id = 33, Name = "Tırnak Bakım Seti", Price = 29.99m, Properties = "Tırnak bakım seti" },
                new Product { Id = 34, Name = "Yüz Maskesi", Price = 19.99m, Properties = "Yüz maskesi" },
                new Product { Id = 35, Name = "Göz Kremi", Price = 59.99m, Properties = "Göz kremi" },
                new Product { Id = 36, Name = "Dudak Peelingi", Price = 29.99m, Properties = "Dudak peelingi" },
                new Product { Id = 37, Name = "Cilt Temizleme Jeli", Price = 39.99m, Properties = "Cilt temizleme jeli" },
                new Product { Id = 38, Name = "Vücut Scrub'ı", Price = 49.99m, Properties = "Vücut scrub'ı" },
                new Product { Id = 39, Name = "Saç Maskesi", Price = 59.99m, Properties = "Saç maskesi" },
                new Product { Id = 40, Name = "Makyaj Fırçası", Price = 19.99m, Properties = "Makyaj fırçası" },

                // Giyim ve Hediyelik Eşya kategorisine dahil ürünler
                new Product { Id = 41, Name = "Tişört", Price = 99.99m, Properties = "Pamuklu tişört" },
                new Product { Id = 42, Name = "Pantolon", Price = 149.99m, Properties = "Şık pantolon" },
                new Product { Id = 43, Name = "Elbise", Price = 199.99m, Properties = "Şık elbise" },
                new Product { Id = 44, Name = "Ceket", Price = 299.99m, Properties = "Şık ceket" },
                new Product { Id = 45, Name = "Kaban", Price = 399.99m, Properties = "Kış kabanı" },

                // Kitap ve Hediyelik Eşya kategorisine dahil ürünler
                new Product { Id = 46, Name = "Roman", Price = 39.99m, Properties = "Roman" },
                new Product { Id = 47, Name = "Bilim Kurgu", Price = 29.99m, Properties = "Bilim kurgu kitabı" },
                new Product { Id = 48, Name = "Tarih Kitabı", Price = 34.99m, Properties = "Tarih kitabı" },
                new Product { Id = 49, Name = "Çocuk Kitabı", Price = 19.99m, Properties = "Çocuklar için kitap" },
                new Product { Id = 50, Name = "Yemek Kitabı", Price = 49.99m, Properties = "Yemek tarifleri kitabı" }
            };
            foreach (var product in products)
            {
                product.ImageUrl = "image1.png";
            }
            // Ürün verileri
            ...
            builder.Entity<ApplicationRole>().HasData(
                ...
                new ApplicationRole { Id = "811f466c-9d06-43f8-a054-24aedbb4161b", Name = "User", NormalizedName = "USER", Description = "Regular user role" }
            );

            // Default users
            var hasher = new PasswordHasher<ApplicationUser>(); // app usere ait pass şifreleyici
            ...
            builder.Entity<ApplicationUser>().HasData(adminUser, userUser);

            // Assign roles to users
            builder.Entity<IdentityUserRole<string>>().HasData(
                new IdentityUserRole<string> { UserId = adminUser.Id, RoleId = "115c7796-cfac-44de-91b5-916eaae125b5" },
                new IdentityUserRole<string> { UserId = userUser.Id, RoleId = "811f466c-9d06-43f8-a054-24aedbb4161b" }
            );
        }
    }
}
