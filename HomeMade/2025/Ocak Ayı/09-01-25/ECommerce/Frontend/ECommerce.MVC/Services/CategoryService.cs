        ...
        public async Task<IEnumerable<CategoryModel>> GetActiveCategoriesAsync()
        {
            try
            {
                ...
                else
                {
                    ...
                    return new List<CategoryModel>(); // eğer result null gelirse yani kategoi gelmez bişi olur yeni kategori listesi yaratıyoruz çünkü apide bir hata olursa vs uygulamanın hala düzgün çalışmasını tetikliyoruz
                }
            }
