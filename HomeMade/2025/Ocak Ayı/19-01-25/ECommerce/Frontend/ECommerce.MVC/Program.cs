...
builder
    ...
    .AddHttpClient(  // bu yazdýðýmýz kod bir http client oluþturur yani bizim tabirimizle bir api olucak
        "ECommerceAPI", // bu isteðin adý buranýn adýný istediðin gibi kullanabilirsin sadece dediðimiz gibi bir ad herhangi bir komut deðil ama biz bir service oluþturucaz ve serviste dicez ki kardeþim tamam client kullanýcaz ama bu clientýn adý ne bana onu söyle ben bir client a istek yapýldýðýnda clientý tanýmlýyim  
