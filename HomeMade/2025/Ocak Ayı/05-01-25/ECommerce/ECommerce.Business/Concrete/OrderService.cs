...
namespace ECommerce.Business.Concrete
{
    public class OrderService : IOrderService
    {
        ...
        private readonly IBasketService _basketService; //basket e ihtiyacımız olucak
        ...
        {
            // ürünlerin tektek olup olmadığını kontrol ediyoruz (databaseden)
            ...
            foreach (var item in order.OrderItems) //siparişin ürünleri içinde gez
            {
                item.OrderId = order.Id; //Her sipariş ürününün OrderId değeri, oluşturulan siparişin Id değeri ile eşleştirilir.
			}
