...
namespace ECommerce.MVC.Services
{
    public class ProductService : BaseService, IProductService
    {
        ...
        public Task<ProductModel> AddAsync()
        {
            throw new NotImplementedException();
        }

        public Task<int> CountAsync(int id)
        {
            throw new NotImplementedException();
        }

        public Task<int> CountByCategoryAsync(int id)
        {
            throw new NotImplementedException();
        }
        ...
        public async Task<IEnumerable<ProductModel>> GetAllByCategoriesAsync(int categoryId)
        {
            try
            {
                var client = GetHttpClient();
